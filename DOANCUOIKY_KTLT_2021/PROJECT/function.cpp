...
void editUserAccount(UserAccount* pUser, string user_name) {
	...
	while (opt != -1) {
		...
		case 1:
			cout << "========================================================================================================================\n\n";
			cout<< "\tNhap username moi (Nhap 0 de quay lai) : ";
			getline(cin, temp);
			if (temp != "0") {
		...
		case 2:
			cout << "========================================================================================================================\n\n";
			cout<< "\tNhap fullname moi (Nhap 0 de quay lai) : ";
			getline(cin, temp);
			if (temp != "0") {
		...
		case 3:
			cout << "========================================================================================================================\n\n";
			cout<< "\tNhap lop chu nhiem moi(Nhap 0 de quay lai): ";
			getline(cin, temp);
			if (temp != "0") {
...
void createSchoolYear(SchoolYear*& pSchoolYear) {
	...
	TextColor(7);
	gotoXY(35, 12);
	cout<<"\t\tNhap 1 de tiep tuc den tao hoc ky cho nam hoc nay : ";
...
void showStudent(Student* &pStudent) {
	...
	while (o != 0) {
		...
		cout << "========================================================================================================================\n\n";
		cout << "\tUsername: " << pStudent->user_name
		...
		case 1:
			cout << "========================================================================================================================\n\n";
			cout<< "\tMat khau la: " << pStudent->user_password << endl;
...
void showStudentList(Student* pStudent, int &num) {
	...
	while (o != 0) {
		...
		int i = 1;
		cout << "========================================================================================================================\n\n";
		cout<< "\tDanh sach hoc sinh (Bam so de xem): \n";

		if (pStudent == nullptr) {
			cout << "\tKhong co hoc sinh nao. Vui long nhap 0 de quay lai : ";
			cin >> o;
			break;
		}
		...
		else
		{
			pStudent = pB;
			if (o > i || o<-2) {
				cout << "\tSo khong hop le, vui long nhap -1 de quay lai : ";
				cin >> o;
				break;
			}
			else {
...
void showClass(Class* &pClass, Semester* &pSemester) {
	...
	while (opt != 0) {
		...
		case -1:
			...
			cin >> t;
			if (t > i) {
				cout << "\n\tNhap sai cu phap. Vui long nhap -1 de quay lai : ";
				cin >> opt;
				break;
			}
			for (int i = t - 1; i > 0; i--) {
		...
		default:
			if (opt > i || opt<-2) {
				...
				while (o != 0) {
					...
					case 1:
						if (pTemp2->pStudent == nullptr) {
							cout << "\n\n\tChua co hoc sinh nao. Vui long nhap -1 de quay lai : ";
							cin >> o;
						}
						else
							showStudentList(pTemp2->pStudent, pTemp2->num_of_student);
...
void Enroll(CourseEnrollment* &pEnroll, Student* &pStudent, Course* &pCourse) {
	...
	while (o != 0) {
		...
		default:
			if (o > i || o < 0) {
				cout << "\tNhap sai cu phap. Vui long nhap -1 de quay lai : ";
				cin >> o;
				break;
			}
			else {
...
void showStudentCourse(StudentCourse* &pStuCourse, Student *&pS) {
	...
	while (o != 0) {
		...
		system("cls");
		cout << "========================================================================================================================\n\n";
		cout<< "\tDanh sach khoa hoc da dang ky (Bam so de xem): \n\n";
		int i = 0;
		if (p == nullptr) {
...
void showStudentInCourse(StudentInCourse* &pStuInCourse, Course *&pCourse) {
	...
	while (o != 0) {
		...
		p = pStuInCourse;
		cout << "========================================================================================================================\n\n";
		cout<< "\tDanh sach hoc sinh da dang ky: (Bam so de xem)\n\n";
		int i = 0;
		while (p != nullptr) {
